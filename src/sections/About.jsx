  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 md:px-10 lg:px-12 py-20 flex flex-col gap-12">
        ...
        >
          <motion.div
            className="relative w-[150px] h-[150px] md:w-[200px] md:h-[200px] rounded-2xl overflow-hidden shadow-2xl bg-gradient-to-br from-[#1cd8d2]/20 to-[#320b63]/20 border border-[#1cd8d2]/25"
          ...
          <div className="flex-1 flex flex-col justify-center text-center md:text-left">
            <h2 className="text-5xl sm:text-6xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-[#1cd8d2] via-[#00bf8f] to-[#1cd8d2]">
              Rohit Singh
            </h2>
            <p className="mt-2 text-lg sm:text-x1 text-white/90 font-semibold">
              Full Stack Developer
            </p>
            <p className="mt-4 text-gray-200 leading-relaxed text-base sm:text-lg max-w-2x1 md:max-w-2x1">
            ...
            <div className="mt-6 grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 max-w-xl">
              {stats.map((item, i) => (
                <motion.div
                  key={i}
                  className="rounded-lg border-2 border-white/30 bg-white/10 px-4 py-2 text-center shadow-lg shadow-black/20 backdrop-blur-sm text-sm"
            ...
            <div className="mt-6 flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center md:justify-start">
              ...
              <a
                href="#contact"
                className="inline-flex  items-center justify-center rounded-lg border border-white/20  text-white px-5 py-3 hover:bg-white/20 bg-white/10 transition "
              >
                Get in Touch
              </a>
            </div>
        ...
        <motion.div
          ...
          viewport={{ once: true, amount: 0.4 }}
        >
          <h3 className="text-2x1 sm:text-3x1 font-bold text-white mb-3">
            About Me
          </h3>
          <p className="text-gray-300 leading-relaxed sm:text-lg">
            I'm a software Developer, Content creator and web-developer Recented
