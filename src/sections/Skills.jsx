...
opacity-20 blur-[120px] animate-pulse delay-500"
      ...
      <motion.p className="mt-2 mb-8 text-white/90 text-base-lg z-10"
      initial={{opacity: 0 , y:-10}}
      whileInView={{opacity:1, y:0}}
      transation={{duration:0.5 , delay:0.1}}
      >
  ...
  <div className="relative w-full overflow-hidden">
    ...
    >
      ...
      {repeated.map((s,i) =>(
   <div 
   key={1} className="flex flex-col items-center gap-2 min-w-[120px]"
   aria-labal = {s.name}
   title ={s.name}
   >
 
 <spam className='hover:scale-125 transation-transform duration-300'>
{s.icon}
 </spam>
 <p className="text-sm">
  {s.name}
